...
public class AesUtils {
	...
	public static void main(String[] args) {
		...
		String source = "dd82b73a64c74d215114e3677536b8584d0655f1ef7926ca5bff1ec4bb1b7064";
		String password = "123456";

		String encryptPassword = Md5Utils.md5(password + "iclass0711").toUpperCase();

		String encryptPrivateKey = Hex.toHexString(
				AesUtils.encode(source.getBytes(), 
						encryptPassword.getBytes(), 
						encryptPassword.substring(16).getBytes())

		);
		
		//b1dfc6c7edfa94575c07cddb048c660ff64d0b1040c2a51ce9951befb7a40520f04ccd944d79bd9d8e17c7e3f0fafee28ea40c5408eea84017d7211ea0498c8df1e6953d5c4c235d039bc6bfa7ee9423
		System.out.println(encryptPrivateKey);

		String desource = new String(
				AesUtils.decode( Hex.decode(encryptPrivateKey), 
						encryptPassword.getBytes(), 
				encryptPassword.substring(16).getBytes()));
